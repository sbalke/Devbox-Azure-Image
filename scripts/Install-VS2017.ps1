...
Write-Host "[${env:username}] Downloading VS2017 ..."
(new-object net.webclient).DownloadFile('https://aka.ms/vs/15/release/vs_community.exe', $installerPath)

Write-Host "[${env:username}] Installing VS2017 ..."
